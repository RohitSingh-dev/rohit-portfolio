...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Rohit Kumar Singh
          <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description">Hi, I'm a creative Java developer based in India, and I'm very passionate and dedicate to my work.</p>
