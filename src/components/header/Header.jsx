...
const Header = () => {
    ...
    window.addEventListener("scroll", function () {
        ...
        /* when the scroll is higher than 200 viewport height, and the scroll-header class
        a tag with the header tag */
  ...
  return (
    <header className="header">
        <nav className="nav container">
            <a href="index.html" className="nav__logo">Rohit .dev</a>
